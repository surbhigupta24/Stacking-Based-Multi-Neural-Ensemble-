# -*- coding: utf-8 -*-
"""
Created on Mon Sep 23 19:22:03 2019
...
dataset = pd.read_excel('leukemiaa.xlsx')
dataset = dataset.drop(['Unnamed: 0'], axis = 1)
dataset.isna().sum()   
dataset = dataset.apply(pd.to_numeric, errors='coerce')
dataset['control/case'].value_counts()
dataset = dataset.dropna()
X = dataset.iloc[:,[2,3,5,9,10,11,12,13,14,15]] 
y = dataset.iloc[:, 0]
